...
**TL;DR:** Constructionline annual membership for UK subcontractors starts at £219/year for Bronze tier on the lowest turnover band (£0–£74,999), but your actual cost depends on which of 15 turnover bands you fall into and which tier your buyer requires. New members pay a one-off joining fee in year one on top of the annual fee, calculated from the same turnover band. Gold is the tier that includes Common Assessment Standard (CAS) desktop certification, which most main contractors and public-sector buyers now require following PPN 03/24. SSIP via Once For All Health & Safety is bundled into every paid tier at no extra charge, which means you don't need a separate SSIP scheme.
</Callout>
